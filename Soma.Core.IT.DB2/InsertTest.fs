...
module InsertTest = 
  ...
  let ``insert : assigned id``() =
    ...
    let department = Db2.insert department
  ...
  let ``insert : assigned composite id``() =
    ...
    let employee = Db2.insert employee
    printfn "%A" employee
  ...
  let ``insert : no version``() =
    ...
    let noVersion = Db2.insert noVersion
    printfn "%A" noVersion
